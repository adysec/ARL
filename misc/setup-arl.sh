...
then
  echo "install wih ..."
  ## 安装 WIH
  wget https://github.com/adysec/ARL/raw/master/tools/wih/wih_linux_amd64 -O /usr/bin/wih && chmod +x /usr/bin/wih
  wih --version
fi
...
if [ ! -f /usr/local/bin/ncrack ]; then
  ...
  wget https://github.com/adysec/ARL/raw/master/tools/ncrack -O /usr/local/bin/ncrack
...
if [ ! -f /usr/local/share/ncrack/ncrack-services ]; then
  ...
  wget https://github.com/adysec/ARL/raw/master/tools/ncrack-services -O /usr/local/share/ncrack/ncrack-services
fi

mkdir -p /data/GeoLite2
if [ ! -f /data/GeoLite2/GeoLite2-ASN.mmdb ]; then
  echo "download GeoLite2-ASN.mmdb ..."
  wget https://github.com/adysec/ARL/raw/master/tools/GeoLite2-ASN.mmdb -O /data/GeoLite2/GeoLite2-ASN.mmdb
fi

if [ ! -f /data/GeoLite2/GeoLite2-City.mmdb ]; then
  echo "download GeoLite2-City.mmdb ..."
  wget https://github.com/adysec/ARL/raw/master/tools/GeoLite2-City.mmdb -O /data/GeoLite2/GeoLite2-City.mmdb
fi
